...
plt.title(f'Female (RF, train, n={len(y_train)})')
...
plt.xlabel('Chronological age')
plt.ylabel('Pre-Arterial biological age')
plt.title(f'Female (RF, test, n={len(y_test)})')
...
# 1. 定义文件路径
filepath = "C:/Users/32684/.spyder-py3/20250418自定义损失/RF_Female.xlsx"  # 或绝对路径（如 r"C:\path\to\A.xlsx"）
