...
plt.title(f'Male (MLR, train, n={len(y_train)})')
...
plt.xlabel('Chronological age')
plt.ylabel('Pre-Arterial biological age')
plt.title(f'Male (MLR, test, n={len(y_test)})')
...
# 1. 定义文件路径
filepath = "C:/Users/32684/.spyder-py3/20250418自定义损失/MLR_Male.xlsx"  # 或绝对路径（如 r"C:\path\to\A.xlsx"）
